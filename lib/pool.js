...
//                    emitLog('Block notification via RPC polling');
	...
	emitLog('Block Mined ' + parseInt(_this.jobManager.currentJob.rpcData.height) + ' notification via ' + sourceTrigger + ' next: '+ nextblock);
//	emitLog('New Block ' + _this.jobManager.currentJob.rpcData.height + ' notification via ' + sourceTrigger);
//	emitLog('Block.rpcData: ' + JSON.stringify(_this.jobManager.currentJob.rpcData));
//        emitLog('Block.height: ' + parseFloat(height) +' +1: ' + Number(height) + 1);
//	emitLog('Coinbase.data1: ' + hex_to_ascii(_this.jobManager.currentJob.rpcData.coinbasetxn.data))
//	emitLog('Coinbase.data2: ' + hex2ascii(_this.jobManager.currentJob.rpcData.coinbasetxn.data))
